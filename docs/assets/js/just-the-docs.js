...
{"0": {
    ...
    "content": "PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit . | Initially application will not operate in any role. Press the corresponding switch to change the operating role. | Press SW2 to change to USB Device mode. | Press SW3 to change to USB Host mode | . | Device mode operation . | Connect the device to the Type A connector J4, which is located on the bottom side of the starter kit. | The application will emulate a USB HID mouse function. The cursor on the PC will rotate. Pressing SW1 will enable and disable the cursor movements. | . | Host mode Operation . | Connect the device to the Type A connector J5, which is located on the top side of the starter kit. | LED2 indicates the file write is complete.. | . | . ",
