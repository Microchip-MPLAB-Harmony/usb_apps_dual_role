...
{"0": {
    ...
    "url": "http://localhost:4000/usb_apps_dual_role/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "MSD Host and HID Device Example",
    "title": "MSD Host and HID Device Example (host_msd_device_hid)",
    "content": "This application demonstrates the ability of the MPLAB Harmony USB Stack to support USB dual role operation - USB Device and Host. ",
    "url": "http://localhost:4000/usb_apps_dual_role/apps/host_msd_device_hid/readme.html#msd-host-and-hid-device-example-host_msd_device_hid",
    "relUrl": "/apps/host_msd_device_hid/readme.html#msd-host-and-hid-device-example-host_msd_device_hid"
  },"2": {
    "doc": "MSD Host and HID Device Example",
    "title": "Description",
    ...
    "url": "http://localhost:4000/usb_apps_dual_role/apps/host_msd_device_hid/readme.html#description",
    "relUrl": "/apps/host_msd_device_hid/readme.html#description"
  },"3": {
    "doc": "MSD Host and HID Device Example",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download it as a zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is usb_apps_dual_role/apps/host_msd_device_hid. The following table gives the details of project configurations, target device used, hardware, and its IDE. Open the project using the respective IDE and build it. | Project Name | IDE | Target Device | Hardware / Configuration | . | pic32mz_ef_curiosity_2.X | MPLABX | PIC32MZ2048EFM144 | Curiosity PIC32MZ EF 2.0 Development Board | . | pic32mz_ef_sk.X | MPLABX | PIC32MZ2048EFH144 | PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit | . ",
    "url": "http://localhost:4000/usb_apps_dual_role/apps/host_msd_device_hid/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/host_msd_device_hid/readme.html#downloading-and-building-the-application"
  },"4": {
    "doc": "MSD Host and HID Device Example",
    "title": " Configuring the Hardware",
    "content": "Curiosity PIC32MZ EF 2.0 Development Board . | Initially, the application will not operate in any role. Press the corresponding switch to change the operating role. | Press SW2 to change to USB Device mode. | Press SW3 to change to USB Host mode | . | Device mode operation . | Use the USB micro-B port J201 to connect the USB device to the USB Host PC. | LED1 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | The application will emulate a USB HID mouse function. The cursor on the PC will rotate. | Pressing SW1 will enable and disable the cursor movements. | . | Host mode Operation . | Connect the USB device to the “TARGET USB” connector (J201) using a USB Type-A Female to micro-B male cable (This cable is not included in the kit). | LED2 indicates the file write is complete. | . | . PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit . | Initially, the application will not operate in any role. Press the corresponding switch to change the operating role. | Press SW2 to change to USB Device mode. | Press SW3 to change to USB Host mode | . | Device mode operation . | Use the micro-A/B port J6 (which is located on the bottom side of the board) to connect the USB device to the USB Host PC. | LED1 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | The application will emulate a USB HID mouse function. The cursor on the PC will rotate. Pressing SW1 will enable and disable the cursor movements. | . | Host mode Operation . | Connect the device to the Type A connector J5, which is located on the top side of the starter kit. | LED2 indicates the file write is complete. | . | . ",
    "url": "http://localhost:4000/usb_apps_dual_role/apps/host_msd_device_hid/readme.html#-configuring-the-hardware",
    "relUrl": "/apps/host_msd_device_hid/readme.html#-configuring-the-hardware"
  },"5": {
    "doc": "MSD Host and HID Device Example",
    "title": "Running the Application",
    "content": "This application demonstrates the Dual Role capability of the MPLAB Harmony USB Stack. The application project includes both, the USB Host and Device Stacks. Both the stacks are initialized during application initialization. During operation, the application polls a switch on the starter kit to trigger a USB role switch. Note that the application cannot simultaneously operate as a host and device. The one USB role is exclusive of the other. Prior to using this demonstration, it is recommended to review the MPLAB Harmony USB Release Notes for any known issues. | Open the project and in MPLAB X IDE. | Build the code and program the device. The application initially will not operate in any USB role. | Press SW2 on the starter kit. This places the application in a USB Device mode. | Connect a USB cable between the micro-B USB connector on the starter kit and a PC USB host. The application will emulate a USB HID mouse function. The cursor on the PC will rotate. Pressing SW1 will enable and disable the cursor movements. Exercise device plug-n-play operation to confirm USB Device operation. | Now try switching the USB role to Host mode. Disconnect the USB cable between the micro USB connector on the starter kit and a PC USB host. Press SW3 on the starter kit. | The application now will be in the USB Host role. Connect a USB pen drive to the USB Host connector on the board. The application will create a file (file.txt) on the pen drive. The completion of the operation is indicated by LED2 on the starter kit. Disconnect the pen drive and connect it to a PC to verify the contents of the file. | Repeat steps 3 through 6 to exercise the role switching capability. | . ",
    "url": "http://localhost:4000/usb_apps_dual_role/apps/host_msd_device_hid/readme.html#running-the-application",
    "relUrl": "/apps/host_msd_device_hid/readme.html#running-the-application"
  },"6": {
    "doc": "MSD Host and HID Device Example",
    "title": "MSD Host and HID Device Example",
    "content": ". ",
    "url": "http://localhost:4000/usb_apps_dual_role/apps/host_msd_device_hid/readme.html",
    "relUrl": "/apps/host_msd_device_hid/readme.html"
  },"7": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": "![Microchip logo](https://raw.githubusercontent.com/wiki/Microchip-MPLAB-Harmony/Microchip-MPLAB-Harmony.github.io/images/microchip_logo.png) ![Harmony logo small](https://raw.githubusercontent.com/wiki/Microchip-MPLAB-Harmony/Microchip-MPLAB-Harmony.github.io/images/microchip_mplab_harmony_logo_small.png) # Microchip MPLAB® Harmony 3 Release Notes ## Harmony 3 USB Dual Role application examples v3.3.0 ### Development kit and demo application support The following table provides the number of USB Dual Role examples available for different development kits. | Development Kits | MPLAB X Applications | IAR Applications | ----------------- | ------------------- | ---------------- | [Curiosity PIC32MZ EF 2.0 Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320209) | 1 | 0 | [PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit](https://www.microchip.com/Developmenttools/ProductDetails/DM320007) | 1 | 0 | ### New Features - Added MPLAB® Code Configurator (MCC) configurations for all demonstration configurations. ### Bug fixes - None ### Known Issues - None ### Development Tools - [MPLAB® X IDE v6.00](https://www.microchip.com/mplab/mplab-x-ide) - [MPLAB® XC32 C/C++ Compiler v4.00](https://www.microchip.com/mplab/compilers) - [IAR Embedded Workbench® for ARM® v8.5](https://www.iar.com/iar-embedded-workbench/#!?architecture=Arm) - MPLAB® X IDE plug-ins:- MPLAB® Code Configurator (MCC) v5.1.1 or above. ## Harmony 3 USB Dual Role application examples v3.2.0 ### Bug fixes - [MPLAB® Discover portal](https://mplab-discover.microchip.com/) metadata for all demonstration application configurations have been updated. ### New Features and Enhancements - None ### Known Issues - None ### Development Tools - Same as v3.1.0 ## Harmony 3 USB Dual Role application examples v3.1.1 ### Bug fixes - [MPLAB® Discover portal](https://mplab-discover.microchip.com/) metadata for all demonstration application configurations have been updated. ### New Features and Enhancements - None ### Known Issues - None ### Development Tools - Same as v3.1.0 ## Harmony 3 USB Dual Role application examples v3.1.0 ### Development kit and demo application support The following table provides the number of USB Dual Role examples available for different development kits. | Development Kits | MPLAB X Applications | IAR Applications | ----------------- | ------------------- | ---------------- | [Curiosity PIC32MZ EF 2.0 Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320209) | 1 | 0 | [PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit](https://www.microchip.com/Developmenttools/ProductDetails/DM320007) | 1 | 0 | ### New Features - A demonstration application configuration has been added for following development boards. - [Curiosity PIC32MZ EF 2.0 Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320209) - All demonstration applications are regenerated with MPLAB® Harmony USB v3.8.0 ### Bug fixes - None ### Known Issues - None ### Development Tools - [MPLAB® X IDE v5.50](https://www.microchip.com/mplab/mplab-x-ide) - [MPLAB® XC32 C/C++ Compiler v3.00](https://www.microchip.com/mplab/compilers) - MPLAB® X IDE plug-ins:- MPLAB® Harmony 3 Launcher v3.6.4 or above ## Harmony 3 USB Dual Role application examples v3.0.1 ### New Features - None ### Bug fixes - Updated MPLAB® Harmony 3 framework relative path. - Removed the compiler switch -Winline. ### Known Issues - None ### Development Tools - [MPLAB® X IDE v5.45](https://www.microchip.com/mplab/mplab-x-ide) - [MPLAB® XC32 C/C++ Compiler v3.00](https://www.microchip.com/mplab/compilers) - [IAR Embedded Workbench® for ARM® v8.5](https://www.iar.com/iar-embedded-workbench/#!?architecture=Arm) - MPLAB® X IDE plug-ins:- MPLAB® Harmony 3 Launcher v3.6.4 or above ## Harmony 3 USB Dual Role application examples v3.0.0 - Applications migrated from USB repository to this new application repository for Dual Role examples ### Development kit and demo application support Following table provides number of USB Device examples available for different development kits. | Development Kits | MPLABx applications | IAR applications | ----------------- | ------------------- | ---------------- | [PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit](https://www.microchip.com/Developmenttools/ProductDetails/DM320007) | 1 | 0 | ### New Features New features added in this release are as follows: - Applications migrated from USB repository to this new application repository for Dual Role examples ### Known Issues The current known issues are as follows: - None ### Development Tools - [MPLAB® X IDE v5.45](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - MPLAB® Harmony Configurator (MHC) v3.6.0 - [MPLAB® XC32 C/C++ Compiler v2.50](https://www.microchip.com/mplab/compilers) - [KEIL MDK v5.30 or above](https://www2.keil.com/mdk5) - [IAR Embedded workbench for ARM v8.50 or above](https://www.iar.com/iar-embedded-workbench/#!?architecture=Arm) ",
    "url": "http://localhost:4000/usb_apps_dual_role/release_notes.html",
    "relUrl": "/release_notes.html"
  },"8": {
    "doc": "Harmony 3 USB Dual Role application examples",
    "title": "Harmony 3 USB Dual Role application examples",
    "content": "[![MCHP](https://www.microchip.com/ResourcePackages/Microchip/assets/dist/images/logo.png)](https://www.microchip.com) # Harmony 3 USB Dual Role application examples MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 USB Dual Role application examples. - [Release Notes](/usb_apps_dual_role/release_notes.html) - [MPLAB® Harmony License](/usb_apps_dual_role/mplab_harmony_license.html) To clone or download these applications from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/usb_apps_dual_role) and then click **Clone** button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these [instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki). # Contents Summary | Folder | Description | --- | --- | apps | Contains Harmony 3 USB Dual Role application examples | docs | Contains documentation in html format for offline viewing (to be used only after cloning this repository onto a local machine). Use [github pages](https://microchip-mplab-harmony.github.io/usb_apps_dual_role/) of this repository for viewing it online. | ## Code Examples The following applications are provided to demonstrate the typical or interesting usage models of USB Dual Role capabilities. | Name | Description | ------------------------- | ---------------------- | MSD Host and HID Device | This application creates a USB Dual Role application that can switch between USB Host MSD Stack and USB Device HID function. The role switch is trigger by a switch press. In the USB Host mode, the application performs read and write operations to a USB pen drive. In the USB Device mode, the application emulates a HID mouse. | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/usb_apps_dual_role/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/usb_apps_dual_role.svg)](https://github.com/Microchip-MPLAB-Harmony/usb_apps_dual_role/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/usb_apps_dual_role.svg)](https://github.com/Microchip-MPLAB-Harmony/usb_apps_dual_role/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/usb_apps_dual_role.svg)](https://github.com/Microchip-MPLAB-Harmony/usb_apps_dual_role/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/usb_apps_dual_role.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/usb_apps_dual_role.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/usb_apps_dual_role.svg?style=social)]() ",
    "url": "http://localhost:4000/usb_apps_dual_role/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "usb_apps_dual_role";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 USB Dual Role application examples";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/usb_apps_dual_role/assets/css/just-the-docs-' + theme + '.css');
}
